...
public class LeapYearCalc {
    public static void main(String[] args) {
        ...
        //bilgilerin karşılaştırılması/comparing values
         if(year%100 == 0) message = year%400 == 0 ? "artık yıldır." : "artık yıl değildir.";
         else message = year%4 == 0 ? "artık yıldır." : "artık yıl değildir";


        //değerlerin ekrana yazdırılması/printing values
        System.out.println("Girdiğiniz yıl : " + year + " " + message);
    }
}
